    ...
    return (
        <div className="login_screen">
            <div className="login_form">
                ...
                <div className="inputs_column">
                    ...
                    <div className="input_box">
                        ...
                        <p className="login_option">Have you forgotten your password?</p>
                        <a href="" className="login_link">Reset password</a>
                    </div>
                </div>
                <input type="submit" value="Continue"/>
                <p className="login_option">Don't have an account? <a href="/signup" className="login_link">Sign Up</a></p>
            </div>
            ...
            <div className="other_options">
                ...
                <a className="guest_link" href="/">Continue as Guest</a>
            </div>
        </div>
    )
}
